...
/**
 * Vista para calcular el perímetro del triángulo equilatero
 * @author cesar
 * @version 1.0
 *
 */
public class PTrianguloEquilatero extends JFrame {
	
	private JLabel lbLado = new JLabel("Medida del lado del triángulo");
	 ...
	 */
	public PTrianguloEquilatero() {
		super.setTitle("Perímetro del triángulo equilatero");
	...
	/**
	 * Metodo para cargar los controles a la vista PTrianguloEquilatero
	 */
	...
	/**
	 * Metodo para obtener el valor del lado del triángulo
	...
	/**
	 * WindowListener para la vista PTrianguloEquilatero
